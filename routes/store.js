exports.home = function(req, res){
  ...
  if (typeof req.sessions.username == 'undefined') res.render('home', { title: 'Ninja Store'});
...
exports.page = function(req, res) {
  ...
  var contents = {
    ...
    contacts: 'You can contact us at <address><strong>Ninja Store</strong>,<br>1, World Ninja Headquarters,<br>Ninja Avenue,<br>NIN80B7-JP,<br>Nihongo.</address>'
  };
